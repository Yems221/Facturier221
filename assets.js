/*!
 * Cafexpres Gestion Reçus - Assets
 ...
 * 
 * Ce fichier contient toutes les images/icônes utilisées dans l'application.
 * Les logos uploadés par l'utilisateur seront stockés en IndexedDB, pas ici.
 */

const ASSETS = {
  // ============================================================================
  // LOGO APPLICATION (Emoji café - extrait de ton index.html)
  // ============================================================================
  logo: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ctext y='75' font-size='75'%3E☕%3C/text%3E%3C/svg%3E",
  
  // ============================================================================
  // ICÔNES PWA (192x192 et 512x512)
  // ============================================================================
  
  // Icône 192x192 (extrait/adapté de ton manifest)
  icon192: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 192 192'%3E%3Crect width='192' height='192' fill='%23FF6F00' rx='48'/%3E%3Ctext x='96' y='140' font-size='120' text-anchor='middle' fill='white'%3E☕%3C/text%3E%3C/svg%3E",
  
  // Icône 512x512 (version agrandie)
  icon512: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'%3E%3Crect width='512' height='512' fill='%23FF6F00' rx='128'/%3E%3Ctext x='256' y='380' font-size='320' text-anchor='middle' fill='white'%3E☕%3C/text%3E%3C/svg%3E",
  
  // Icône 96x96 pour shortcuts
  icon96: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 96'%3E%3Crect width='96' height='96' fill='%23FF6F00' rx='24'/%3E%3Ctext x='48' y='70' font-size='60' text-anchor='middle' fill='white'%3E☕%3C/text%3E%3C/svg%3E",
  ...
  // Placeholder produit
  productPlaceholder: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Crect width='100' height='100' fill='%23F5F5F5'/%3E%3Crect x='25' y='25' width='50' height='50' fill='%23DDDDDD' rx='8'/%3E%3Ctext x='50' y='55' font-size='12' text-anchor='middle' fill='%23999999'%3E📦%3C/text%3E%3C/svg%3E",
  
  // ============================================================================
  // ICÔNES UI MATERIAL DESIGN (SVG)
  // ============================================================================
...
console.log('[ASSETS] Assets Cafexpres chargés avec succès');
console.log('[ASSETS] Logo:', ASSETS.logo.substring(0, 50) + '...');
console.log('[ASSETS] Icônes UI:', Object.keys(ASSETS.icons).length, 'icônes');
